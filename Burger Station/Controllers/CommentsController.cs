...
namespace Burger_Station.Controllers
{
    public class CommentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,PostDate,PostTitle,PostBody")] Comment comment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,PostDate,PostTitle,PostBody")] Comment comment)
        {
            if (id != comment.Id)
            {
                return NotFound();

...
namespace Burger_Station.Controllers
{
    public class MenuItemsController : Controller
    {
        ...
        public MenuItemsController(Burger_StationContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Price")] MenuItem menuItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Price")] MenuItem menuItem)
        {
            if (id != menuItem.Id)
            {
                return NotFound();
